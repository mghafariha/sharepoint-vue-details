...
export default {
    ...
    computed: {
        ...mapState({
            fieldType (state) { return state.approveFields[this.fieldId].Type },
            fieldInternalName (state) { return state.approveFields[this.fieldId].InternalName },
            description (state) { return state.approveFields[this.fieldId].Description},
